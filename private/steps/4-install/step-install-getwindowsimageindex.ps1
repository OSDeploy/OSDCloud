function step-install-getwindowsimageindex {
    ...
    param (
        ...
        [Parameter(Mandatory = $false)]
        [System.String]
        $EditionId = $global:OSDCloudInitialize.OSEditionId,

        [Parameter(Mandatory = $false)]
        [System.String]
        $ImageName = $global:OSDCloudInitialize.LocalImageName
    )
    #=================================================
    # Start the step
