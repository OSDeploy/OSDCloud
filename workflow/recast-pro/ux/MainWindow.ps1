...
function Save-TaskSequenceSteps {
	...
	$WorkflowTaskObject = $global:DeployOSDCloud.Flows | Where-Object { $_.Name -eq $TaskSequenceName } | Select-Object -First 1
...
function Update-TaskSequenceSteps {
	...
	$WorkflowTaskObject = $global:DeployOSDCloud.Flows | Where-Object { $_.Name -eq $selectedTaskSequence } | Select-Object -First 1
